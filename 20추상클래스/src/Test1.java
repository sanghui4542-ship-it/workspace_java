...
//    for 문으로 명세서를 모두 출력한 뒤, 총 지급액을 합산해 출력한다.	
	public static void main(String[] args) {
		...
		Employee[]  empList = new Employee[3];
				    ...
				    empList[0] = new FullTimeEmployee("홍길동", "E001", "개발팀", 3000000, 500000);
				    empList[1] = new ContractEmployee("김철수", "E002", "디자인팀", 15000, 120);
				    empList[2] = new FullTimeEmployee("이영희", "E003", "기획팀", 2800000, 300000);
