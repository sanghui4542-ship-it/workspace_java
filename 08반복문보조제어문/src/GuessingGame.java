...
public class GuessingGame {
	...
	public static void main(String[] args) {
		...
		System.out.println("제가 생각한 1부터 10까지의 숫자를 맞춰 보세요.");
		
		//do-while 반복문 : 최소 한번은 반복문 내부의 실행코드가 실행되고, 조건식을 검사하여 계속 반복할지 결정.
		do {
			
			System.out.println("예상하시는 숫자를 입력해 주세요: "); //입력 안내 메세지 출력
			...
			if(userGuess < targetNumber) {
				System.out.println("너무 작은 수를 입력했어요. 다시 입력 해보세요! 기회를 줄게요!");
			}else if(userGuess > targetNumber) {
				System.out.println("너무 큰 수를 입력했어요. 다시 입력 해보세요! 기회 줄게요!");
			}
